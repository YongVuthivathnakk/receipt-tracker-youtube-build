  ...
  return (
    <div className='flex flex-col min-h-screen'>
      ...
      dark:from-gray-900 dark:to-gray-800'>
        <div className='container px-4 md:px-6 mx-auto items-center'>
          <div className='flex flex-col items-center space-y-4 text-center'>
            <div className='space-y-2'>
              <h1 className='text-3xl font-bold tracking-tighter sm:text-4xl
              md:text-5xl lg:text-6xl'>
                Intelligent Reciept Scanning
              </h1>
              <p className='mx-auto max-w-[700px] text-gray-500 md:text-xl
              dark:text-gray-400'>
                Scan, analyze, and organize your reciepts with AI-powered
                precision. Save time and gain insights from your expences.
              </p>
            </div>

            <div className=' flex space-x-4'>
              <Link href="/receipts">
                <button className="bg-blue-600 flex items-center justify-center text-white px-4 py-2 rounded-[5px] cursor-pointer text-sm">
                  Get Started <ArrowRight className='ml-2 h-4 w-4'/>
                </button>
              </Link>
              <Link href="#">
                <button className="border text-center bg-white border-gray-300 px-4 py-2 rounded-[5px] cursor-pointer text-sm">
                  Learn More
                </button>
              </Link>
            </div>
        ...
        <div className='container px-4 md:px-6 mx-auto'>
          <div className='flex flex-col items-center justify-center space-y-4 text-center'>
            <div className='space-y-2'>
              ...
              dark:text-gray-400'>
                Our AI-powered platform transform how you handle receipts and track expences.
              </p>
            </div>
            ...
            <div className='grid grid-cols-1 md:grid-cols-3 gap-8 mt-12'>
              ...
              {/* Feature 3 */}
              <div className='flex flex-col items-center space-y-2 border border-gray-200 rounded-lg p-6 dark:border-gray-800'>
                <div className='p-3 rounded-full bg-purple-100 dark:bg-purple-600'>
      ...
      <section className='py-16 md:py-24 bg-gray-50 dark:bg-gray-900'>
        ...
        <div className='grid grid-cols-1 px-4 md:grid-cols-3 gap-8 mt-12 max-w-5xl mx-auto'>
          {/* Free Tier */}
          <div className='flex flex-col p-6 bg-white border border-gray-200 rounded-lg shadow-sm  dark:border-gray-800 dark:bg-gray-950'>
            ...
            <div className='mt-6'>
              <Link href="/manage-plan">
                <button className="shadow-sm w-full border text-center bg-white border-gray-300 px-4 py-2 rounded-[5px] cursor-pointer text-sm">
                  Sign Up Free
                </button>
              </Link>
            </div>
          ...
          {/* Pro Teir */}
          <div className='flex flex-col p-6 bg-blue-50 border border-blue-200 rounded-lg shadow-sm relative  dark:border-gray-800 dark:bg-gray-950'>
            ...
            <div className='mt-6'>
              <Link href="/manage-plan">
                <button className="shadow-sm w-full border text-center bg-blue-600 text-white border-gray-300 px-4 py-2 rounded-[5px] cursor-pointer text-sm">
                  Get Started
                </button>
              </Link>
            </div>
        ...
        <div className='container px-4 md:px-6 py-8 mx-auto'>
          <div className='flex flex-col md:flex-row justify-between items-center'>
            <div className='flex items-center space-x-1'>
              ...
              <span className='text-xl font-semibold'>Expnencio</span>
            </div>
